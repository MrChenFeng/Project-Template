...
class AFLW(Dataset):
    ...
    def __init__(self, dataroot='/home/chen/Datasets/Faces and human pose/AFLW/aflw/data', is_rotated=False,
                 is_train=True, transform=None):
        # specify annotation file for dataset
        if is_train:
            self.csv_file = '/home/chen/Datasets/Faces and human pose/AFLW/aflw/data/face_landmarks_aflw_train.csv'
        else:
            self.csv_file = '/home/chen/Datasets/Faces and human pose/AFLW/aflw/data/face_landmarks_aflw_train.csv'
...
if __name__ == '__main__':
    ...
    t = AFLW(transform=Compose([Rescale((224, 224)), ToTensor(), Normalize(mean, std)]),is_rotated=True)
    tmp = t[1000]
